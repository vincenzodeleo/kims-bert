...
class BertTarget(nn.Module):
    ...
    def __init__(self, args, vocab_size):
        ...
        # NSP.
        ## nsp_linear_* renamed to sp_linear_* for compatibility with recent UER versions
    ...
    def forward(self, memory_bank, tgt):
        ...
        ## nsp_linear_* renamed to sp_linear_* for compatibility with recent UER versions
        output_nsp = torch.tanh(self.sp_linear_1(memory_bank[:, 0, :]))
        output_nsp = self.sp_linear_2(output_nsp)
